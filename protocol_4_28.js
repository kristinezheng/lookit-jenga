function generateProtocol() {
    ...
    let frames = {
        "instructions": {
            ...
            "blocks": [{
                ...
                },
                {
                    "title": "Welcome!",
                    "listblocks": [{
                        "text": "Welcome to playing with block towers! In this study, we are looking at when children develop intuitions about the stability of stacked blocks and whether their emotional facial expressions correlate with actual changes in the block tower’s stability as the tower is being built. Please follow the instructions below to participate."
                    }]
                },
                {
                    "title": "Instructions",
        ...
        "video-config": {
            ...
            "troubleshootingIntro": "If you're having any trouble getting your webcam set up, please feel email Kristine, a researcher for this project, at kxzheng@mit.edu and we'd be glad to help you out!",
            "displayFullscreenOverride": true
        },
        ...
        "next-button1": {
            "kind": "exp-lookit-instructions",
            "blocks": [{
                "title": "Completed! Click NEXT to proceed to another video."//,
                // "listblocks": [{
                //     "text": "Click NEXT to proceed to another video."
                // }]
            }],
        ...
        "next-button3": {
            "kind": "exp-lookit-instructions",
            "blocks": [{
                "title": "Completed! Click NEXT to conclude the study."//,
                // "listblocks": [{
                //     "text": "Click NEXT to proceed to another video."
                // }]
            }],
        ...
        "stop-recording-with-video": {
            ...
            "video": "attentiongrabber",
            "displayFullscreen": true,
            "waitForUploadMessage": "Stopping video recording, please wait!"
        },
        "video-consent": {
            "gdpr": false,
            ...
            "purpose": "We are interested in how children understand complex physical events, like whether a stack of blocks might stay up or fall down. For young children, it can be hard to use complicated language to ask them questions like “On a scale from 1-10, how unstable do you think this tower is?” or “What do you think is the percent chance that this tower will fall if we add one more block to it?” In this study, we want to view subtle changes in children’s emotional expressions as they watch videos of these dynamic events. If we can use their facial expressions to get a continuous measure of children’s changing expectations, then we can use that in future research.",
            ...
            "payment": "After you participate, we will email you a $5 Amazon.com gift card within seven days to thank you for your time (only one per child). To be eligible for compensation, we ask that you (1) provide a valid consent video (we will show you how!), (2) make sure your child is in the age range specified, and (3) ensure that your child is visible during the recorded videos. Your child does not need to finish the entire study in order to be eligible for compensation. There are no other direct benefits to you or your child from participating, but we hope you will enjoy the experience.",
            "research_rights_statement": "You are not waiving any legal claims, rights, or remedies because of your participation in this research study. If you feel you have been treated unfairly, or you have questions regarding your rights as a research subject, you may contact Laura Schulz at lschulz@mit.edu.",
        ...
        "positioning-config": {
            ...
            "instructionBlocks": [{
                ...
                {
                    "text": "The green Next button will start the study. Press the button once you and your child are ready to go!",
                    "title": "When you're ready, press the green button."
                }
            ],
        ...
        "my-exit-survey": {
            ...
            "debriefing": {
                "text": "<b>Purpose</b> <br> Thank you for participating in our experiment! This might seem like a very simple task: just watching movies of block towers being built. However, your child is helping us learn something important: whether children’s emotional expressions correlate with changes in the stability of these block towers. <br><br><b>Payment</b><br> Once we confirm your consent video, we will email you a $5 Amazon.com gift card within seven days to thank you for your time (only one per child). To be eligible for compensation, you (1) provided a valid consent video, (2) made sure your child is in the age range specified, and (3) ensured that your child was visible during the recorded videos. Your child did not need to finish the entire study in order to be eligible for compensation. There are no other direct benefits to you or your child from participating, but we hope you enjoyed the experience. <br><br><b> Experimental Design</b> <br> We showed your child three short movies of blocks being stacked one by one. Your child’s facial expressions and body language were recorded as they watched the movies. We expect that children may react with a subtle change in their emotional expressions to certain moments in the videos when the block tower becomes unstable. However, we might be wrong! Your child may have had no particular reaction to our movies or no reaction that correlates with our predictions. In our studies, the children are always correct; their responses tell us if, when, and how our methods and ideas need to change. <br><br><b>Why this matters</b><br>The physical properties of events involve many complex dynamics. We are interested in children’s sensitivity to these complex changes. We can’t easily ask young children to give us a rating of a tower’s stability on a 0-10 scale at each time point as the tower is being built but we think we might be able to use children’s natural reactions (e.g., increasing suspense or anticipation) to get a continuous measure of their changing expectations about the towers’ stability. We can then see if children’s responses correlate with models of the actual physics and changing stability of these towers – and if children’s expectations about these events change with age and experience. This study might give us insight into the development of our intuitions about objects and forces and help us understand more about how children learn about the physical world. Thank you so much for participating in our study! Research on child development would not be possible without your support! <br><br><b>Learn More </b><br> Check out the broader developmental research that our experiment builds upon here: <a href='https://news.mit.edu/2011/infant-cognition-0527' target='_blank' rel='noopener'> Click to learn about “Inside the infant mind.“</a> Feel free to contact Laura Schulz at lschulz@mit.edu if you have further questions! ",
                "image": {
