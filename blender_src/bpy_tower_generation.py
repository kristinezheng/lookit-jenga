...
def make_floor(mat):
    floor = bpy.ops.mesh.primitive_cube_add(size = 1, location=(0.0, 0.0, -0.05), scale = (10000.0,10000.0,0.1))
...
#        print(obj)
        ...
        obj_pos = (obj['pos'][0] + x_shift*i, obj['pos'][1], obj['pos'][2])
#        print(i, obj['pos'])

        bpy.ops.mesh.primitive_cube_add(size=1, location = obj_pos, scale = x_y_z_dim)
        ...
        # bpy.context.object.rigid_body.mass = obj['mass']
...
block_tower, positions = make_tower(parsed_dict, wood_mat, x_shift = 0.15)
#0,0.3,0.15
...
#     e.keyframe_insert("rotation_euler", frame=i/2)
